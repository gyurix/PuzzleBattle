...
public class Coin extends Circle {
  ...
  public double getInitialPositionYForFall() {
    return initialPositionYForFall;
  }
  ...
  public double getInitialPozitionXForFall() {
    return initialPozitionXForFall;
  }
  ...
  public double getMaximumHeighForFall() {
    return maximumHeighForFall;
  }
